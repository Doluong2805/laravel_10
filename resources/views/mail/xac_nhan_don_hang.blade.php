                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c es-m-p0r es-m-p0l"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Hey {{ $info['nguoi_mua'] }} has shipped your
                                                                        order</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;padding-right:5px;padding-bottom:10px">
                                                                    <h2
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <table border="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="padding:0;Margin:0;border-bottom:1px solid #ceeaf4;background:unset;height:1px;width:100%;margin:0px">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#068FC1;font-size:14px"><img
                                                                            src="{{ explode(",",$value->hinh_anh)[0] }}" alt
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            class="p_image" width="130"></a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
